...
const uint16_t PROGMEM combo_vg[] = {KC_SCLN,    KC_G,    COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_1_a(
    ...
    KC_MINS,           KC_COMM, KC_DOT,  KC_SLSH, KC_Y,  KC_HASH,   KC_DLR,                  KC_EXLM,      KC_W,    KC_R,    KC_C,    KC_K,   KC_G,    KC_SCLN,
    CTL_T(KC_ENT),     KC_A,    KC_I,    KC_E,    HN,      LCTL(KC_C),KC_RABK,               KC_LABK,      KC_L,    KC_N,    KC_D,    KC_T,   KC_S,    CTL_T(KC_TAB),
    KC_DQUO,           KC_QUOT, KC_U,    KC_O,    KC_H,    KC_F5,     KC_AT,   KC_CAPS,      KC_TILD,      KC_X,    KC_P,    KC_F,    KC_B,   KC_V,    LT(SYMB,KC_GRV),
