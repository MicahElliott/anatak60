...
const uint16_t PROGMEM combo_bd[] = {KC_D,    KC_B,    COMBO_END};
const uint16_t PROGMEM combo_fk[] = {KC_F,    KC_K,    COMBO_END};
...
combo_t key_combos[] = {
    ...
    COMBO(combo_kg, LCTL(LGUI(KC_V))),
    COMBO(combo_pv, KC_PIPE),
    COMBO(combo_fk, LCTL(KC_V)),
    COMBO(combo_vf, LCTL(KC_X)),
    COMBO(combo_bd, LCTL(KC_C)),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT_1_a(
    ...
    KC_MINS,           KC_COMM, KC_DOT,  KC_SLSH, KC_EQL,  KC_HASH,   KC_DLR,                KC_EXLM,      KC_Y,    KC_D,    KC_C,    KC_W,     KC_G,    KC_K,
